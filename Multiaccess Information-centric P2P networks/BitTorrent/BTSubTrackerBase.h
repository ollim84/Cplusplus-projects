...
class INET_API BTSubTrackerBase : public TCPSrvHostApp
{
	...
	public:
		...
		cArray& peers();
		int contains(BTSubTrackerStructBase*) const;
		size_t seeds() const;
		...
		void cleanUpPeers();
		void cleanRemovePeer(BTSubTrackerStructBase*);
 ...
 */
class INET_API BTSubTrackerClientHandlerBase : public TCPServerThreadBase
{
	protected:
	...
	public:
		/* Constructor */
		BTSubTrackerClientHandlerBase();
		/* Destructor */
		virtual ~BTSubTrackerClientHandlerBase();
		/* set and get methods */
		size_t tstate() const;
		void setTstate(size_t state);
		/* Redefined method from TCPServerThreadBase */
		BTSubTrackerBase* hostModule();
 ...
 */
class INET_API BTSubTrackerStructBase : public cObject
{
	protected:
	...
	public:
		/* Constructor */
		BTSubTrackerStructBase(const IPvXAddress&, const string&, size_t, const string&, simtime_t, bool);
		/* Destructor */
		virtual ~BTSubTrackerStructBase();
		/* operator == */
		bool operator==(const BTSubTrackerStructBase&);
		/* set and get methods */
