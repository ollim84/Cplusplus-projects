...
#define INTERNAL_TRACKER_COM_MSG				63002
...
class BTSubTrackerClientCommunicationBase;
...
class INET_API BTSubTrackerClientBase : public TCPSrvHostApp
{
	protected:
...
// 		cMessage* evtRemThread;		// remove thread
		...
		BTSubTrackerClientCommunicationBase* handler_var;
		IPvXAddress destAddr;
		simtime_t announceInterval_var;			// time interval between consequtive announce messages
...
// 		virtual void findAndSetIPAddress();		
	...
	public:
		/* Constructor */
		BTSubTrackerClientBase();
		/* Destructor */
		virtual ~BTSubTrackerClientBase();
		/* set and get methods */
// 		size_t cstate() const;
...
// 		void setCtrans(size_t);
		...
		void setHandler(BTSubTrackerClientCommunicationBase*);
		BTSubTrackerClientCommunicationBase* getHandler();
		
		
		//const char* toString(int);
		virtual void scheduleTrackerCommunication();
 ...
 */
class INET_API BTSubTrackerClientCommunicationBase : public TCPServerThreadBase
{
	protected:
		/* New members in BitTorrentSubTrackerClientCommunicationBase */
	...
	public:
		/* Constructor */
		BTSubTrackerClientCommunicationBase();
		/* Destructor */
		virtual ~BTSubTrackerClientCommunicationBase();
		/* set and get methods */		
		size_t cstate() const;
		void setCstate(size_t);
		size_t ctrans() const;
		...
		BTSubTrackerClientBase* hostModule();
